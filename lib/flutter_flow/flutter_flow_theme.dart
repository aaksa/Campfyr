...
abstract class FlutterFlowTheme {
  ...
  late Color mediumEmphasis;
  late Color border;
  late Color highEmphasis;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF002F33);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF564F4C);
  late Color primaryBackground = const Color(0xFFF8EFEA);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFFFD54F);
  late Color accent2 = const Color(0xFFFF8A65);
  ...
  late Color mediumEmphasis = const Color(0xFFA09384);
  late Color border = const Color(0xFFEEE3D9);
  late Color highEmphasis = const Color(0xFF564F4C);
}
