...
import 'chat_list_card_model.dart';
export 'chat_list_card_model.dart';
...
class _ChatListCardWidgetState extends State<ChatListCardWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatListCardModel());
                        ...
                        Text(
                          ...
                          style: FlutterFlowTheme.of(context)
                              ...
                              .override(
                                fontFamily: 'Roboto',
                                color:
                                    FlutterFlowTheme.of(context).mediumEmphasis,
                                letterSpacing: 0.0,
                                fontWeight: FontWeight.normal,
                              ),
                        ),
